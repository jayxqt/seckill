...
public class SeckillServiceimpl implements SeckillService {
    ...
    /**
     * 使用注解控制事物方法的优点： 1、开发团队达成一致约定，明确标注事物方法的编程风格。而编程式事物，一次配置，永久使用需要团队每个技术去查看事物的相关配置
     * 2、保证事物方法的执行时间尽可能短，不要穿插其他网络操作，RPC/HTTP请求或者剥离到事物方法外部 3、不是所有的方法都需要事物，如只有一条修改操作，只读操作不需要事物控制。
     * @param seckillId
     * @param userPhone
     * @param md5
     * @return
